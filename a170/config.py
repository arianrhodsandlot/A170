...
LOG_TEMPLATE_START_DOWNLOAD = os.getenv('LOG_TEMPLATE_START_DOWNLOAD', '开始下载 {}')
LOG_TEMPLATE_START_UPLOAD = os.getenv('LOG_TEMPLATE_START_UPLOAD', '开始上传 {}')
...
REPORT_GMAIL = os.getenv('A170_CHATROOM_NAME')
